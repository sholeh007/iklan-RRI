 <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
     <div class="container-fluid">
         ...
         <!-- Brand -->
         <a class="navbar-brand pt-0" href="<?= base_url('admin/index'); ?>">
         ...
         <div class="collapse navbar-collapse" id="sidenav-collapse-main">
             ...
             <ul class="navbar-nav">
                 <li class="nav-item">
                     <a class=" nav-link " href=" <?= base_url('admin/index'); ?>"> <i
                 ...
                 <li class="nav-item">
                     <a class="nav-link " href="<?= base_url('admin/pengguna'); ?>">
                         <i class="fas fa-users text-info"></i> User Manajemen
                     </a>
                 </li>
                 <li class="nav-item">
                     <a class="nav-link " href="<?= base_url('admin/siaran'); ?>">
                         <i class="fas fa-broadcast-tower text-success"></i> Manajemen Siaran
                     </a>
                 </li>
                 <li class="nav-item">
                     <a class="nav-link " href="<?= base_url('admin/order'); ?>">
                         <i class="ni ni-cart text-danger"></i> Pesanan
                     </a>
                 </li>
             </ul>
             <!-- Divider -->
